...
final lang = "spanisch/";
final filePath = 'lib/services/scraper/verbs_textfiles/spanishVerbs.txt';
final fileName = 'lib/services/scraper/conjugations_dicts/spanishConjugations.json';
...
*/
          ...
          if (pronoun != null) {
            ...
            if (timeForms.contains(timeForm)) {
              timeFormDict[timeForm]
                  [pronoun] = {"mainVerb": mainVerb, "auxVerb": auxVerb}; // set newPronoun here
            }
